            ...
            >
                ...
                <div className="flex justify-between mb-9">
                    <div className="flex flex-col gap-[7px]">
                        <h3 className="font-semibold text-[20px] text-black">{t("bookingsCancel.title")}</h3>
                        <p className="flex flex-col font-semibold text-[16px] text-[#585858]">
                            {t("bookingsCancel.confirmPrefix")}
                            <strong className="text-black"> {t("bookingsCancel.confirmSample")}</strong>
                        </p>
                    </div>
                    <button 
                        onClick={onClose}
                ...
                <div className="flex gap-[71px] mb-[28px]">
                    ...
                    <div className="flex flex-col gap-[4px]">
                        <span className="font-semibold text-[20px] text-black opacity-60">{t("bookingsCancel.total")}</span>
                        <strong className="font-semibold text-[32px] text-black">{t("bookingsCard.sampleTotal")}</strong>
                    </div>
                </div>
                ...
                <aside className="flex items-center gap-[13px] rounded-[5px] bg-[#FAFAFF] p-[23px_19px] mb-[22px]">
                    ...
                    <p className="font-semibold text-[15px] text-black">{t("bookingsCancel.refundHint")}</p>
                </aside>
