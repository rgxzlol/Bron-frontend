...
export const BookingCancelModal = ({ isOpen, onClose }: BookingCancelModalProps) => {
    const t = useTranslations('BookingCancelModal');
            ...
            >
                ...
                <div className="flex justify-between mb-9">
                    <div className="flex flex-col gap-[7px]">
                        <h3 className="font-semibold text-[20px] text-black">{t('title')}</h3>
                        <p className="flex flex-col font-semibold text-[16px] text-[#585858]">
                            {t('confirmText')}
                            <strong className="text-black"> {t('confirmDetails')}</strong>
                        </p>
                    </div>
                    <button 
                        onClick={onClose}
                ...
                <div className="flex gap-[71px] mb-[28px]">
                    ...
                    <div className="flex flex-col gap-[4px]">
                        ...
                        <strong className="font-semibold text-[32px] text-black">{t('price')}</strong>
                    </div>
                </div>
                ...
                <aside className="flex items-center gap-[13px] rounded-[5px] bg-[#FAFAFF] p-[23px_19px] mb-[22px]">
                    ...
                    <p className="font-semibold text-[15px] text-black">{t('refundNotice')}</p>
                </aside>
