...
export const BookingNav = () => {
  ...
  return (
    <nav aria-label={t("bookings.navLabel")}>
      <ul className="relative flex gap-[46px] isolate">
        ...
        <li>
          ...
          >
            {t("bookings.upcoming")}
            <span
              className={`ml-[7px] flex h-7 min-w-7 items-center justify-center rounded-full px-[7px] text-[20px] font-semibold text-white transition-colors duration-300
