...
export default function Categories() {
  return (
    <section className="my-[35px]">
      <h2 className="mb-[60px] text-[24px] font-semibold">Категории</h2>
      <div className="flex gap-[50px]">
        {categories.map((category) => (
          <Link
            key={category.id}
            href={routes.home}
            className={`${s.links} flex w-full max-w-[130px] flex-col items-center gap-1 py-[15px] text-center`}
          >
            <div
            ...
            <span className="min-h-[64px] font-semibold">{category.title}</span>
